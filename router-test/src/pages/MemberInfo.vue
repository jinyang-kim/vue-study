<template>
  <div class="mt-5">
    <img :src="member.photo" :alt="member.name" :title="member.name" class="img" />
    ...
    <br />
    <br />
    <router-link :to="{name: 'members'}">목록으로</router-link>
    <!--<router-link to="/members">목록으로</router-link>-->
  </div>
</template>
...
import members from '@/data-sample/members.json';
